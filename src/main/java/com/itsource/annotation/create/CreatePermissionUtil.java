package com.itsource.annotation.create;


import com.itsource.annotation.OwnPermission;
import com.itsource.annotation.ScanPackage;
...
public class CreatePermissionUtil {
		...
		for (Class<?> controllerClass : allControlerClass) {
			...
			if (classOwnAnno != null && classMvcAnno != null) {
				...
				if (!dbSns.contains(sn)) {
					Permission permission = new Permission(name, sn, resource);
	...
	public static void main(String[] args) {
		List<Permission> permission = CreatePermissionUtil.encapsulationAnnoPermission("xxx");
